...
GROUPS_DESCRIPTION = "autoScalingGroupsDescription"
...
GET_INSTANCES_IDS = "aws ec2 describe-instances --query 'Reservations[*].Instances[*].{InstanceId:InstanceId,InstanceType:InstanceType,ImageId:ImageId}' --output json > instances.json"
GET_AUTOSCALING_GROUPS = "aws autoscaling describe-auto-scaling-groups --output json > asgroups.json"
